...
import Square14Raw from "$lib/components/loaders/square/square-14.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square14Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-14.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-14.svelte",
			filecode: Square14Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[13].id,
	title: squareItems[13].title,
	description: squareItems[13].description,
	category: squareItems[13].section,
};
