...
import Square6Raw from "$lib/components/loaders/square/square-6.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square6Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-6.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[5].id,
	title: squareItems[5].title,
	description: squareItems[5].description,
	category: squareItems[5].section,
};
