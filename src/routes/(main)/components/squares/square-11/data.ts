...
import Square11Raw from "$lib/components/loaders/square/square-11.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square11Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-11.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-11.svelte",
			filecode: Square11Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[10].id,
	title: squareItems[10].title,
	description: squareItems[10].description,
	category: squareItems[10].section,
};
