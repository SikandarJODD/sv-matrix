...
import Square5Raw from "$lib/components/loaders/square/square-5.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square5Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-5.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[4].id,
	title: squareItems[4].title,
	description: squareItems[4].description,
	category: squareItems[4].section,
};
