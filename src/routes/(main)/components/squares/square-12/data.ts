...
import Square12Raw from "$lib/components/loaders/square/square-12.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square12Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-12.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-12.svelte",
			filecode: Square12Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[11].id,
	title: squareItems[11].title,
	description: squareItems[11].description,
	category: squareItems[11].section,
};
