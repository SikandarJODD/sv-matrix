...
import Square16Raw from "$lib/components/loaders/square/square-16.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square16Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-16.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-16.svelte",
			filecode: Square16Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[15].id,
	title: squareItems[15].title,
	description: squareItems[15].description,
	category: squareItems[15].section,
};
