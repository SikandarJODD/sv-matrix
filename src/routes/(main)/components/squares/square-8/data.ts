...
import Square8Raw from "$lib/components/loaders/square/square-8.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square8Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-8.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[7].id,
	title: squareItems[7].title,
	description: squareItems[7].description,
	category: squareItems[7].section,
};
