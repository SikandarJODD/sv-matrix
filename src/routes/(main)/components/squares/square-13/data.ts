...
import Square13Raw from "$lib/components/loaders/square/square-13.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square13Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-13.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-13.svelte",
			filecode: Square13Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[12].id,
	title: squareItems[12].title,
	description: squareItems[12].description,
	category: squareItems[12].section,
};
