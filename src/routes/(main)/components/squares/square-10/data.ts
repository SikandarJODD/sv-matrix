...
import Square10Raw from "$lib/components/loaders/square/square-10.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square10Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-10.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-10.svelte",
			filecode: Square10Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[9].id,
	title: squareItems[9].title,
	description: squareItems[9].description,
	category: squareItems[9].section,
};
