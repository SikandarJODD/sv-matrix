...
import Square7Raw from "$lib/components/loaders/square/square-7.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square7Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-7.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[6].id,
	title: squareItems[6].title,
	description: squareItems[6].description,
	category: squareItems[6].section,
};
