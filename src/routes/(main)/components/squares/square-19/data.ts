...
import Square19Raw from "$lib/components/loaders/square/square-19.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square19Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-19.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-19.svelte",
			filecode: Square19Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[18].id,
	title: squareItems[18].title,
	description: squareItems[18].description,
	category: squareItems[18].section,
};
