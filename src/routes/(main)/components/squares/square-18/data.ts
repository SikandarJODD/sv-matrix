...
import Square18Raw from "$lib/components/loaders/square/square-18.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square18Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-18.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-18.svelte",
			filecode: Square18Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[17].id,
	title: squareItems[17].title,
	description: squareItems[17].description,
	category: squareItems[17].section,
};
