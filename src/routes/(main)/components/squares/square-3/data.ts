...
import Square3Raw from "$lib/components/loaders/square/square-3.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "SquareThreeProps",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-3.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[2].id,
	title: squareItems[2].title,
	description: squareItems[2].description,
	category: squareItems[2].section,
};
