...
import Square15Raw from "$lib/components/loaders/square/square-15.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square15Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-15.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-15.svelte",
			filecode: Square15Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[14].id,
	title: squareItems[14].title,
	description: squareItems[14].description,
	category: squareItems[14].section,
};
