...
import Square4Raw from "$lib/components/loaders/square/square-4.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "SquareFourProps",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-4.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: squareItems[3].id,
	title: squareItems[3].title,
	description: squareItems[3].description,
	category: squareItems[3].section,
};
