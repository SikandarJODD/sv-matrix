...
import Square20Raw from "$lib/components/loaders/square/square-20.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Square20Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by square-20.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "square-20.svelte",
			filecode: Square20Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
...
const meta: ComponentMeta = {
	id: squareItems[19].id,
	title: squareItems[19].title,
	description: squareItems[19].description,
	category: squareItems[19].section,
};
