...
import Circle18Raw from "$lib/components/loaders/circles/circle-18.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[17].id,
	title: circleItems[17].title,
	description: circleItems[17].description,
	category: circleItems[17].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle18Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-18.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-18.svelte",
			filecode: Circle18Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
