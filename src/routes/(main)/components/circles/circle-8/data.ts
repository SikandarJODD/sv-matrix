...
import Circle8Raw from "$lib/components/loaders/circles/circle-8.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[7].id,
	title: circleItems[7].title,
	description: circleItems[7].description,
	category: circleItems[7].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle8Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-8.svelte.",
		props: [
			{
				name: "size",
				type: "number",
