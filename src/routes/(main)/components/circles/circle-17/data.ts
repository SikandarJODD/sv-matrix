...
import Circle17Raw from "$lib/components/loaders/circles/circle-17.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[16].id,
	title: circleItems[16].title,
	description: circleItems[16].description,
	category: circleItems[16].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle17Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-17.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-17.svelte",
			filecode: Circle17Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
