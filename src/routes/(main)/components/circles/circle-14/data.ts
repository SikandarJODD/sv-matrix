...
import Circle14Raw from "$lib/components/loaders/circles/circle-14.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[13].id,
	title: circleItems[13].title,
	description: circleItems[13].description,
	category: circleItems[13].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle14Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-14.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-14.svelte",
			filecode: Circle14Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
