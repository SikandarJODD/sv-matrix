...
import Circle15Raw from "$lib/components/loaders/circles/circle-15.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[14].id,
	title: circleItems[14].title,
	description: circleItems[14].description,
	category: circleItems[14].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle15Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-15.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-15.svelte",
			filecode: Circle15Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
