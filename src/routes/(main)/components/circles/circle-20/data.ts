...
import Circle20Raw from "$lib/components/loaders/circles/circle-20.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[19].id,
	title: circleItems[19].title,
	description: circleItems[19].description,
	category: circleItems[19].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle20Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-20.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-20.svelte",
			filecode: Circle20Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
