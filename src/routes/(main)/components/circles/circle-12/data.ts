...
import Circle12Raw from "$lib/components/loaders/circles/circle-12.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[11].id,
	title: circleItems[11].title,
	description: circleItems[11].description,
	category: circleItems[11].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle12Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-12.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-12.svelte",
			filecode: Circle12Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
