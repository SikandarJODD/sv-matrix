...
import Circle9Raw from "$lib/components/loaders/circles/circle-9.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[8].id,
	title: circleItems[8].title,
	description: circleItems[8].description,
	category: circleItems[8].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle9Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-9.svelte.",
		props: [
			{
				name: "size",
				type: "number",
