...
const meta: ComponentMeta = {
	id: circleItems[18].id,
	title: circleItems[18].title,
	description: circleItems[18].description,
	category: circleItems[18].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle19Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-19.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-19.svelte",
			filecode: Circle19Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
