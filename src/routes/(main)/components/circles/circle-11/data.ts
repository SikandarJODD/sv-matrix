...
import Circle11Raw from "$lib/components/loaders/circles/circle-11.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[10].id,
	title: circleItems[10].title,
	description: circleItems[10].description,
	category: circleItems[10].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle11Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-11.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-11.svelte",
			filecode: Circle11Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
