...
import Circle16Raw from "$lib/components/loaders/circles/circle-16.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[15].id,
	title: circleItems[15].title,
	description: circleItems[15].description,
	category: circleItems[15].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle16Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-16.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-16.svelte",
			filecode: Circle16Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
