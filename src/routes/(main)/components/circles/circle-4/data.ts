...
import Circle4Raw from "$lib/components/loaders/circles/circle-4.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle4Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-4.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[3].id,
	title: circleItems[3].title,
	description: circleItems[3].description,
	category: circleItems[3].section,
};
