...
import Circle6Raw from "$lib/components/loaders/circles/circle-6.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle6Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-6.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[5].id,
	title: circleItems[5].title,
	description: circleItems[5].description,
	category: circleItems[5].section,
};
