...
import Circle13Raw from "$lib/components/loaders/circles/circle-13.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[12].id,
	title: circleItems[12].title,
	description: circleItems[12].description,
	category: circleItems[12].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle13Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-13.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-13.svelte",
			filecode: Circle13Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
