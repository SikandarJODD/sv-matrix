...
import Circle2Raw from "$lib/components/loaders/circles/circle-2.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle2Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-2.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[1].id,
	title: circleItems[1].title,
	description: circleItems[1].description,
	category: circleItems[1].section,
};
