...
import Circle10Raw from "$lib/components/loaders/circles/circle-10.svelte?raw";

const meta: ComponentMeta = {
	id: circleItems[9].id,
	title: circleItems[9].title,
	description: circleItems[9].description,
	category: circleItems[9].section,
};
...
const props: PropsTable[] = [
	{
		name: "Circle10Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-10.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const installBlock: InstallComponentDocs = {
	installCode: [
		{
			filename: "circle-10.svelte",
			filecode: Circle10Raw,
			lang: "svelte",
			isExpand: true,
		},
	],
