...
import Circle5Raw from "$lib/components/loaders/circles/circle-5.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle5Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-5.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[4].id,
	title: circleItems[4].title,
	description: circleItems[4].description,
	category: circleItems[4].section,
};
