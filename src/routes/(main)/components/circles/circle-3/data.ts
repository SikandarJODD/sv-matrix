...
import Circle3Raw from "$lib/components/loaders/circles/circle-3.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle3Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-3.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[2].id,
	title: circleItems[2].title,
	description: circleItems[2].description,
	category: circleItems[2].section,
};
