...
import Circle1Raw from "$lib/components/loaders/circles/circle-1.svelte?raw";
...
const props: PropsTable[] = [
	{
		name: "Circle1Props",
		desc: "Primary loader props. Defaults shown here are the effective defaults applied by circle-1.svelte.",
		props: [
			{
				name: "size",
				type: "number",
...
const meta: ComponentMeta = {
	id: circleItems[0].id,
	title: circleItems[0].title,
	description: circleItems[0].description,
	category: circleItems[0].section,
};
